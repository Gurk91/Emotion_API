...
file_path = './conversation_data_neg/'
...
model = Chatbot(size_layer, num_layers, embedded_size, vocabulary_size_from + 4, vocabulary_size_to + 4, learning_rate, batch_size)

sess.run(tf.global_variables_initializer())

saver = tf.train.Saver(tf.global_variables(), max_to_keep=2)
checkpoint_dir = os.path.abspath(os.path.join('./', "checkpoints_neg_chatbot"))
...
checkpoint_file = tf.train.latest_checkpoint(os.path.join('./', 'checkpoints_neg_chatbot'))
